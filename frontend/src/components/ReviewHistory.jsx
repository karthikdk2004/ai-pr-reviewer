import { Trash2, ExternalLink, GitPullRequest, Clock, Search, AlertCircle } from 'lucide-react'
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-bg-border">
            {reviews.map((review, idx) => (
              <tr
                key={review.id}
                className="hover:bg-accent/[0.03] transition-all duration-200 group cursor-pointer"
